...
setblock 40 80 16 minecraft:redstone_wire
setblock 41 80 16 minecraft:redstone_wire
setblock 43 80 16 minecraft:redstone_wire
setblock 24 80 16 minecraft:repeater[facing=west,delay=1]
setblock 39 80 16 minecraft:repeater[facing=west,delay=4]
setblock 42 80 16 minecraft:repeater[facing=west,delay=1]
