...
setblock 15 80 0 minecraft:repeater[facing=west,delay=1]
setblock 18 80 0 minecraft:repeater[facing=west,delay=4]
setblock 21 80 0 minecraft:repeater[facing=west,delay=1]
