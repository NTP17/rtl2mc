...
setblock 15 80 0 minecraft:repeater[facing=south,delay=1]
setblock 15 80 -3 minecraft:repeater[facing=south,delay=4]
setblock 15 80 -6 minecraft:repeater[facing=south,delay=1]
