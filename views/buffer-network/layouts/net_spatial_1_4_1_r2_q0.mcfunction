...
setblock 15 80 0 minecraft:repeater[facing=east,delay=1]
setblock 12 80 0 minecraft:repeater[facing=east,delay=4]
setblock 9 80 0 minecraft:repeater[facing=east,delay=1]
