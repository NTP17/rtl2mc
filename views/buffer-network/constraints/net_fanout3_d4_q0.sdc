...
set_max_delay 18 -from [get_ports A] -to [get_ports {Q[2]}]
set_max_delay 14 -from [get_ports A] -to [get_ports {Q[3]}]
set_max_delay 16 -from [get_ports A] -to [get_ports {Q[4]}]
